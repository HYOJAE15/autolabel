...
#UI파일 연결, 다중 ui 파일 연결
# mainwind.ui 에서 각 메뉴의 창을 띄운다.
form_1 = resource_path("./uiscripts/mainwind.ui")
form_class_1 = uic.loadUiType(form_1)[0]

form_2 = resource_path("./uiscripts/toolswind.ui")
form_class_2 = uic.loadUiType(form_2)[0]

#화면을 띄우는데 사용되는 Class 선언, Mainwindow
class Mainwind(QMainWindow, form_class_1) :
    def __init__(self) :
        super().__init__()
        self.setupUi(self)
